...
var popupContent = "<form action='kati.php'> <div style='text-align: center;'> <input placeholder='Ακτίνα (μέτρα)' style='display: inline-block; width: 97%; text-align: center;  height: 20px;' type='number' min='1' max='2500' name='radius' oninvalid='this.setCustomValidity(\"Η ακτίνα πρέπει να είναι μεταξύ του 1 και 2500\")' oninput='this.setCustomValidity(\"\")' required> <br>  <input placeholder='Ώρα άφιξης' type='text' name='timeToArrive' pattern='^([01]\\d|2[0-3])([:.])([0-5]\\d)$' required oninvalid='this.setCustomValidity(\"Η ώρα πρέπει να είναι στη μορφή 14.02 ή 14:02\")' oninput='this.setCustomValidity(\"\")' style='margin-top: 10px; height: 20px; text-align: center;'> </div> <br> <div style='margin-top: 12px; text-align: center;'><input style='height: 21px; font-size: 12px; border-radius: 5px; border: 1px solid coral; background-corol: lightgrey;' type='submit' value='Αποστολή'></div> </form>";  
